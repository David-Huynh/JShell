...
/**
 * The Copy class is responsible for both copying and overwriting StorageUnits according to
...
public class Copy extends ShellCommand {
  ...
  /**
   * Helper function for performOutcome, executes the case where the destination path (copyHere) is an
   * existing StorageUnit, copies/overwrites toCopy to copyHere
   * 
  ...
  /**
   * Helper function for performOutcome, executes the case where the destination path (copyHere) is a
   * new StorageUnit, copies and overwrites toCopy to copyCopy
   * 
   * @param toCopy The StorageUnit that is to be copied
  ...
  /**
   * Copies StorageUnit toCopy inside Directory copyHereParent, renames toCopy to newName
   * 
