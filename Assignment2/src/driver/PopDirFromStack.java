...
/**
 * The PopDirFromStack command is used by the user to remove the top entry from the JShell's
 * directory stack and make it its current directory.
 */
...
public class PopDirFromStack extends ShellCommand {
  ...
  /**
   * Tell the JShell to remove the top entry from the directory stack and make it its current
   * directory.
   * 
  ...
  public static void performOutcome(JShell shell, String[] parameters) {
    ...
    Stack<Directory> dirStack = shell.getDirStack(); // get shell.dirStack's reference
