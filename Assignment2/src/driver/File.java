...
/**
 * A File is a type of StorageUnit (similar to a .txt file) that stores data. It's able to be
 * printed to the command line of JShell and have its data be modified.
 */
...
public class File extends StorageUnit{
   ...
   * @param text The data the File is to store, in the form of a string
   * @param parentDir The location the File is the be created in
   */
   ...
   * 
   * @param text The string to be appended to the File's contents
   */
   ...
   * 
   * @param text This is the data for the File's data to be overwritten by
   */
   ...
   * 
   * @param stdout The StdOut to send to
   */
   ...
   * 
   * @param parentDir The directory where the cloned file will be located
