...
public class ClientURLTest {
  ...
  File file1;
  File stdOutFile;
  String txtContents = "There was once a king who had an illness, and no one believed that he\n"
  ...
  String htmlContents = "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Strict//EN\" "
  ...
  public void testPerformOutcomeWithoutSameHtmlFile() {
    String [] parameters = {"curl", "http://www.brainjar.com/java/host/test.html"};
